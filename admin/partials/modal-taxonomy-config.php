<?php
/**
 * Modal: taxonomy field configuration.
 *
 * @since 1.0.0
...
?>
<div id="flowbridge-modal-taxonomy" class="flowbridge-modal" style="display: none;">
		...
		<div class="flowbridge-modal-body">
			<div class="flowbridge-modal-section">
				...
				<div class="flowbridge-events-checkboxes">
					<label><input type="checkbox" name="events[]" value="term.created" /> <?php esc_html_e( 'Created', 'flowbridge-for-n8n' ); ?></label>
					<label><input type="checkbox" name="events[]" value="term.updated" /> <?php esc_html_e( 'Updated', 'flowbridge-for-n8n' ); ?></label>
					<label><input type="checkbox" name="events[]" value="term.deleted" /> <?php esc_html_e( 'Deleted', 'flowbridge-for-n8n' ); ?></label>
				</div>
			</div>

			<div class="flowbridge-modal-section">
				<h4><?php esc_html_e( 'Sample Term', 'flowbridge-for-n8n' ); ?></h4>
				<p class="description">
					<?php esc_html_e( 'Select a sample term to detect available meta fields.', 'flowbridge-for-n8n' ); ?>
				</p>
				<select class="flowbridge-sample-selector" data-load-action="flowbridge_n8n_load_term_fields">
					<option value=""><?php esc_html_e( '-- Select a term --', 'flowbridge-for-n8n' ); ?></option>
				</select>
					...
					<table class="flowbridge-fields-table">
						...
						<tbody>
							<tr class="flowbridge-fields-empty">
								<td colspan="6"><?php esc_html_e( 'Load fields by selecting a sample term above.', 'flowbridge-for-n8n' ); ?></td>
							</tr>
						</tbody>
					</table>
				</div>
